...
public class PincushionUtils {
    ...
    static float[] approximateInverse(Distortion distort) {
        float maxRadius = 1;
        int numSamples = 100;
    ...
    static float getMaxRadius(ScreenParams screenParams, GvrViewerParams gvrViewParams) {
    ...
    private static float getMaxRadius(float[] tanAngleRect) {
